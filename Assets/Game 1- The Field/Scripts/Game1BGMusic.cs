...
public class Game1BGMusic : MonoBehaviour
{
    ...
    [SerializeField] private int[] persistentScenes = { 1, 2, 3, 4 }; // Scenes where this music should play
    
    // Private variables
    private static Game1BGMusic instance;
    ...
    private void CheckCurrentScene()
    {
        ...
        if (ShouldPlayInScene(currentSceneIndex))
        {
            if (!audioSource.isPlaying)
            {
                ...
                shouldFadeOut = false;
                fadeTimer = 0f;
                Debug.Log($"[Game1BGMusic] Started playing music in scene {currentSceneIndex}");
            }
        }
        else
        {
            ...
            if (audioSource.isPlaying)
            {
                ...
                shouldFadeIn = false;
                fadeTimer = 0f;
                Debug.Log($"[Game1BGMusic] Should not play in scene {currentSceneIndex}, fading out");
            }
        }
    }
    ...
    private void OnSceneLoaded(Scene scene, LoadSceneMode mode)
    {
        ...
        Debug.Log($"[Game1BGMusic] Scene loaded: {loadedSceneIndex}");
        ...
        if (ShouldPlayInScene(loadedSceneIndex))
        {
            if (!audioSource.isPlaying)
            {
                ...
                shouldFadeOut = false;
                fadeTimer = 0f;
                Debug.Log($"[Game1BGMusic] Started playing music in scene {loadedSceneIndex}");
            }
            else
            {
                ...
                Debug.Log($"[Game1BGMusic] Continuing to play music in scene {loadedSceneIndex}");
            }
        }
        else
        {
            ...
            if (audioSource.isPlaying)
            {
                ...
                shouldFadeIn = false;
                fadeTimer = 0f;
                Debug.Log($"[Game1BGMusic] Should not play in scene {loadedSceneIndex}, fading out");
            }
        }
    }
    ...
    private void Update()
    {
        ...
        if (shouldFadeIn && audioSource.isPlaying)
        {
            ...
            if (t >= 1f)
            {
                ...
                Debug.Log("[Game1BGMusic] Fade in complete");
            }
        }
        ...
        if (shouldFadeOut && audioSource.isPlaying)
        {
            ...
            if (t >= 1f)
            {
                ...
                shouldFadeOut = false;
                Debug.Log("[Game1BGMusic] Fade out complete");
            }
        }
    }
